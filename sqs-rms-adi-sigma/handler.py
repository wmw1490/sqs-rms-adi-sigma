...
#            receipt_handle = response['Messages'][0]['ReceiptHandle']   #message['ReceiptHandle']
            sqs.delete_message(QueueUrl='https://sqs.us-east-2.amazonaws.com/578839498373/sqs-rms-adi-in', receipt_handle)
        except:
